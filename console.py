...
class HBNBCommand(cmd.Cmd):
    ...
    def do_assistance(self, arg):
        """To get help on a command, type help <topic>.
        """
        return super().do_assistance(arg)

    def do_end_of_file(self, line):
    ...
    def do_display(self, arg):
        ...
        """
        args = arg.split()
        if not check_classname(args, check_id=True):
            return
...
def check_classname(args, check_id=False):
